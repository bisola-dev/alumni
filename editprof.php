...
$resultt6 = mysqli_query($conn, "SELECT * FROM  profhist WHERE emal = '$alumnamail' AND id=$profid");
 ...
 if (isset($_POST['clok'])){
   $prof = mysqli_real_escape_string($conn, strip_tags($_POST['prof']));
   $yrobt= mysqli_real_escape_string($conn, strip_tags($_POST['yrobt']));
  


  $new = mysqli_query($conn," UPDATE profhist SET prof='$prof', yrobt='$yrobt' WHERE id=$profid");


  echo'<script type="text/javascript">
        alert("Congratulations! you have successfully updated your professional  data history.")
         ...
         <!-- Content Wrapper. Contains page content -->
            ...
            <section class="content-header">
               ...
               <div class="header-title">
                  ...
                  <small>Please fill in your professional  history</small>
               </div>
            </section>
            <!-- Main c
                     ...
                     <div class="panel panel-bd lobidrag">
                        <div class="panel-heading">
                           <div class="btn-group" id="buttonlist"> 
                              <h4> Form c ::Professional  History</h4> 
                           </div>
                        </div>
           <div class="row"> 
            <div class="col-md-12">
              ...
              <form action="" method="POST">
                    ...
                    <div class="form-group">
                      <label>Professional Qualification <span class="text-danger"></span></label>
                        <input type="text" name="prof" class="form-control" value="<?php echo $prof2;?>">
                    </div>
                    ...
                    <div class="form-group">
                      <label>Year obtained <span class="text-danger">*</span></label>
                       <input type="number" name="yrobt"  class="form-control" value="<?php echo $yrobt2;?>">
                    </div>
                  </div>

                  <div class="form-group">   
                <div class="submit-section">
                  <button type="submit" name="clok" class="btn btn-primary submit-btn m-r-10">Update  Professional  History</button>
                   </div>
                </div>
              </div>
         </form>
