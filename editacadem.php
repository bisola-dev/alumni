...
$resultt2 = mysqli_query($conn, "SELECT * FROM academhist WHERE emal = '$alumnamail' AND id=$academid");
   while ($row=mysqli_fetch_assoc($resultt2)) {
                             
                            $degreex2 =$row['degreex'];
                            $skool2 =$row['skool'];
                            $yrstart2  = $row['yrstart'];
                            $yrend2 =$row['yrend'];}
 ...
 if (isset($_POST['clok'])){
  ...
  $new = mysqli_query($conn," UPDATE academhist SET skool='$skool', yrstart='$yrstart',yrend='$yrend',degreex='$degreex' WHERE id=$academid");


  echo'<script type="text/javascript">
        alert("Congratulations! you have successfully updated your academic data.")
                     ...
                     <div class="panel panel-bd lobidrag">
                        <div class="panel-heading">
                           <div class="btn-group" id="buttonlist"> 
                              <h4> Form A :: EDit Academic History</h4> 
                           </div>
                        </div>
           <div class="row"> 
            <div class="col-md-12">
              ...
              <form action="" method="POST">
                    ...
                    <div class="form-group">
                      <label>School Attended <span class="text-danger"></span></label>
                        <input type="text" name="skool" class="form-control" value="<?php echo $skool2;?>">
                    </div>
                  ...
                  <div class="col-sm-6 col-md-3">
                    <div class="form-group">
                      <label>From <span class="text-danger">*</span></label>
                       <input type="date" name="yrstart"  class="form-control" value="<?php echo $yrstart2;?>">
                    </div>
                  </div>
                  ...
                  <div class="col-sm-6 col-md-3">
                    <div class="form-group">
                      <label>To <span class="text-danger">*</span></label>
                       <input type="date" name="yrend"  class="form-control" value="<?php echo $yrend2;?>">
                    </div>
                  </div>
                  ...
                  <div class="col-sm-6 col-md-6">
                    <div class="form-group">
                      <label>Certificate <span class="text-danger"></span></label>
                        <input type="text" name="degreex"  class="form-control" value="<?php echo $degreex2;?>">
                    </div>

                  <div class="col-sm-6 col-md-3">
                  <div class="form-group">   
                <div class="submit-section">
                  <button type="submit" name="clok" class="btn btn-primary submit-btn m-r-10">Update Academic Data</button>
                   </div>
                </div>
              </div>
         </form>
